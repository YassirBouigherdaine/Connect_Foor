...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function checkBoard() {
        ...
        for (let i = 0; i < validArrays.length; i++) {
            ...
            //check those squares if they all have the class of player1

            function myFunction1(value) {
                return value.classList.contains('player1');
            }

             //check those squares if they all have the class of player2

            function myFunction2(value) {
                return value.classList.contains('player2');
            }
        ...
        squares[j].onclick = () => {
            ...
            if (!squares[j].classList.contains('taken') && squares[j + 7].classList.contains('taken')) {
                ...
                if (curr_player == 1) {
                    ...
                    squares[j].classList.add('player1');
                    ...
                    squares[j].classList.add('taken');
                    squares[j].classList.add('player2');
